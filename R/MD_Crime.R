...
#'   \item{Crime Name2}{A facotr denoting the specific name of a crime (e.g, Assault, Burglary, Robbery, etc)}
...
#'   \item{Dispatch Time}{Time of police dispatch for a crime}
#'   \item{Start Date}{Reported starting date of a crime, by Month/Date/Year}
#'   \item{Start Time}{Reported starting time of a crime}
#'   \item{End Date}{Reported ending date of a crime, by Month/Date/Year}
